<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="jp.co.nagatake.database.dao.Employee"
...
<body>
	...
	<form method="post" action="UpdateServlet" style="display: inline">
		<table>
			<tr>
				<td>empid</td>
				<td><input type="text" name="empid"
					value="<%=form.getEmpid()%>" readonly="readonly" /></td>
			</tr>
			<tr>
				<td>name</td>
